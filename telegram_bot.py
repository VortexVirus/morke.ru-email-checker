...
class TelegramInterface:
    ...
    async def request_captcha(self, filename):
        ...
        print("request_captcha self:", id(self))
        print("future:", id(self.captcha_future))
    ...
    async def captcha_command(
        ...
        print("CAPTCHA COMMAND RECEIVED")
        print("captcha_command called")
        print("self:", id(self))
        print("future:", self.captcha_future)

        if self.captcha_future:
            print("future id:", id(self.captcha_future))
        if str(update.effective_chat.id) != str(CHAT_ID):
            return
        ...
        if len(context.args) != 1:
            ...
            raise Exception("captcha_command usage")
            return
        ...
        if self.captcha_future is None:
            ...
            raise Exception("captcha_command no captcha pending")
            return
        ...
        if self.captcha_future.done():
            ...
            print("captcha command already done")
            return
